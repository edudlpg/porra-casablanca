...
export const worldCup2026Teams: TeamSeed[] = [
  { name: "México", flagUrl: flagUrl("mx") },
  { name: "Sudáfrica", flagUrl: flagUrl("za") },
  { name: "República de Corea", flagUrl: flagUrl("kr") },
  { name: "República Checa", flagUrl: flagUrl("cz") },
  { name: "Canadá", flagUrl: flagUrl("ca") },
  { name: "Bosnia y Herzegovina", flagUrl: flagUrl("ba") },
  { name: "Catar", flagUrl: flagUrl("qa") },
  { name: "Suiza", flagUrl: flagUrl("ch") },
  { name: "Brasil", flagUrl: flagUrl("br") },
  { name: "Marruecos", flagUrl: flagUrl("ma") },
  { name: "Haití", flagUrl: flagUrl("ht") },
  { name: "Escocia", flagUrl: flagUrl("gb-sct") },
  { name: "Estados Unidos", flagUrl: flagUrl("us") },
  { name: "Paraguay", flagUrl: flagUrl("py") },
  { name: "Australia", flagUrl: flagUrl("au") },
  { name: "Turquía", flagUrl: flagUrl("tr") },
  { name: "Alemania", flagUrl: flagUrl("de") },
  { name: "Curazao", flagUrl: flagUrl("cw") },
  { name: "Costa de Marfil", flagUrl: flagUrl("ci") },
  { name: "Ecuador", flagUrl: flagUrl("ec") },
  { name: "Países Bajos", flagUrl: flagUrl("nl") },
  { name: "Japón", flagUrl: flagUrl("jp") },
  { name: "Suecia", flagUrl: flagUrl("se") },
  { name: "Túnez", flagUrl: flagUrl("tn") },
  { name: "Bélgica", flagUrl: flagUrl("be") },
  { name: "Egipto", flagUrl: flagUrl("eg") },
  { name: "Irán", flagUrl: flagUrl("ir") },
  { name: "Nueva Zelanda", flagUrl: flagUrl("nz") },
  { name: "España", flagUrl: flagUrl("es") },
  { name: "Cabo Verde", flagUrl: flagUrl("cv") },
  { name: "Arabia Saudí", flagUrl: flagUrl("sa") },
  { name: "Uruguay", flagUrl: flagUrl("uy") },
  { name: "Francia", flagUrl: flagUrl("fr") },
  { name: "Senegal", flagUrl: flagUrl("sn") },
  { name: "Irak", flagUrl: flagUrl("iq") },
  { name: "Noruega", flagUrl: flagUrl("no") },
  { name: "Argentina", flagUrl: flagUrl("ar") },
  { name: "Argelia", flagUrl: flagUrl("dz") },
  { name: "Austria", flagUrl: flagUrl("at") },
  { name: "Jordania", flagUrl: flagUrl("jo") },
  { name: "Portugal", flagUrl: flagUrl("pt") },
  { name: "RD de Congo", flagUrl: flagUrl("cd") },
  { name: "Uzbekistán", flagUrl: flagUrl("uz") },
  { name: "Colombia", flagUrl: flagUrl("co") },
  { name: "Inglaterra", flagUrl: flagUrl("gb-eng") },
  { name: "Croacia", flagUrl: flagUrl("hr") },
  { name: "Ghana", flagUrl: flagUrl("gh") },
  { name: "Panamá", flagUrl: flagUrl("pa") },
];
...
export const worldCup2026Rounds: RoundSeed[] = [
  ...
  },
  {
    ...
    unlockAt: etDate("2026-06-28", "00:00"),
    startDate: etDate("2026-06-28", "12:00"),
    endDate: etDate("2026-07-03", "23:59"),
  },
  {
    name: "Octavos de final",
    unlockAt: etDate("2026-07-04", "00:00"),
    startDate: etDate("2026-07-04", "12:00"),
    endDate: etDate("2026-07-07", "23:59"),
  },
  {
    name: "Cuartos de final",
    unlockAt: etDate("2026-07-09", "00:00"),
    startDate: etDate("2026-07-09", "16:00"),
    endDate: etDate("2026-07-11", "23:59"),
  },
  {
    name: "Semifinales",
    unlockAt: etDate("2026-07-14", "00:00"),
    startDate: etDate("2026-07-14", "20:00"),
    endDate: etDate("2026-07-15", "23:59"),
  },
  {
    name: "Tercer puesto",
    unlockAt: etDate("2026-07-18", "00:00"),
    startDate: etDate("2026-07-18", "16:00"),
    endDate: etDate("2026-07-18", "23:59"),
  },
  {
    name: "Final",
    unlockAt: etDate("2026-07-19", "00:00"),
    startDate: etDate("2026-07-19", "18:00"),
    endDate: etDate("2026-07-19", "23:59"),
  },
];
...
export const worldCup2026Fixtures: FixtureSeed[] = [
  ...
  { roundName: "Dieciseisavos de final", homeTeam: "2º Grupo A", awayTeam: "2º Grupo B", startsAt: etDate("2026-06-28", "18:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo E", awayTeam: "3º Grupo A/B/C/D/F", startsAt: etDate("2026-06-29", "12:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo F", awayTeam: "2º Grupo C", startsAt: etDate("2026-06-29", "16:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo C", awayTeam: "2º Grupo F", startsAt: etDate("2026-06-29", "20:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo I", awayTeam: "3º Grupo C/D/F/G/H", startsAt: etDate("2026-06-30", "12:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "2º Grupo E", awayTeam: "2º Grupo I", startsAt: etDate("2026-06-30", "16:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo A", awayTeam: "3º Grupo C/E/F/H/I", startsAt: etDate("2026-06-30", "20:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo L", awayTeam: "3º Grupo E/H/I/J/K", startsAt: etDate("2026-07-01", "12:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo D", awayTeam: "3º Grupo B/E/F/I/J", startsAt: etDate("2026-07-01", "16:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo G", awayTeam: "3º Grupo A/E/H/I/J", startsAt: etDate("2026-07-01", "20:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "2º Grupo K", awayTeam: "2º Grupo L", startsAt: etDate("2026-07-02", "12:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo H", awayTeam: "2º Grupo J", startsAt: etDate("2026-07-02", "16:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo B", awayTeam: "3º Grupo E/F/G/I/J", startsAt: etDate("2026-07-02", "20:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo J", awayTeam: "2º Grupo H", startsAt: etDate("2026-07-03", "12:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "1º Grupo K", awayTeam: "3º Grupo D/E/I/J/L", startsAt: etDate("2026-07-03", "16:00") },
  { roundName: "Dieciseisavos de final", homeTeam: "2º Grupo D", awayTeam: "2º Grupo G", startsAt: etDate("2026-07-03", "20:00") },

  { roundName: "Octavos de final", homeTeam: "Ganador Partido 74", awayTeam: "Ganador Partido 77", startsAt: etDate("2026-07-04", "14:00") },
  { roundName: "Octavos de final", homeTeam: "Ganador Partido 73", awayTeam: "Ganador Partido 75", startsAt: etDate("2026-07-04", "20:00") },
  { roundName: "Octavos de final", homeTeam: "Ganador Partido 76", awayTeam: "Ganador Partido 78", startsAt: etDate("2026-07-05", "14:00") },
  { roundName: "Octavos de final", homeTeam: "Ganador Partido 79", awayTeam: "Ganador Partido 80", startsAt: etDate("2026-07-05", "20:00") },
  { roundName: "Octavos de final", homeTeam: "Ganador Partido 83", awayTeam: "Ganador Partido 84", startsAt: etDate("2026-07-06", "14:00") },
  { roundName: "Octavos de final", homeTeam: "Ganador Partido 81", awayTeam: "Ganador Partido 82", startsAt: etDate("2026-07-06", "20:00") },
  { roundName: "Octavos de final", homeTeam: "Ganador Partido 86", awayTeam: "Ganador Partido 88", startsAt: etDate("2026-07-07", "14:00") },
  { roundName: "Octavos de final", homeTeam: "Ganador Partido 85", awayTeam: "Ganador Partido 87", startsAt: etDate("2026-07-07", "20:00") },

  { roundName: "Cuartos de final", homeTeam: "Ganador Partido 89", awayTeam: "Ganador Partido 90", startsAt: etDate("2026-07-09", "18:00") },
  { roundName: "Cuartos de final", homeTeam: "Ganador Partido 93", awayTeam: "Ganador Partido 94", startsAt: etDate("2026-07-10", "18:00") },
  { roundName: "Cuartos de final", homeTeam: "Ganador Partido 91", awayTeam: "Ganador Partido 92", startsAt: etDate("2026-07-11", "14:00") },
  { roundName: "Cuartos de final", homeTeam: "Ganador Partido 95", awayTeam: "Ganador Partido 96", startsAt: etDate("2026-07-11", "20:00") },

  { roundName: "Semifinales", homeTeam: "Ganador Partido 97", awayTeam: "Ganador Partido 98", startsAt: etDate("2026-07-14", "20:00") },
  { roundName: "Semifinales", homeTeam: "Ganador Partido 99", awayTeam: "Ganador Partido 100", startsAt: etDate("2026-07-15", "20:00") },

  { roundName: "Tercer puesto", homeTeam: "Perdedor Partido 101", awayTeam: "Perdedor Partido 102", startsAt: etDate("2026-07-18", "16:00") },
  { roundName: "Final", homeTeam: "Ganador Partido 101", awayTeam: "Ganador Partido 102", startsAt: etDate("2026-07-19", "18:00") },
];
