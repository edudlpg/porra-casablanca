...
import { isMatchEditable, isRoundPredictionWindow } from "@/lib/utils";
...
export function PredictionForm({
  ...
  const editable = isMatchEditable(match.startsAt, match.isLocked, match.round.unlockAt, match.round.startDate);
  const roundOpen = isRoundPredictionWindow(match.round.unlockAt, match.round.startDate);
